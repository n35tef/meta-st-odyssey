# Odyssey extras: bring-up / test tools for the 40-pin header SPI TFT + touch.
#   fbset        - inspect /dev/fb1, move the console with con2fbmap
#   evtest       - check the ads7846 touch input events
#   libgpiod-tools (gpioinfo/gpioget/gpioset) - poke header GPIOs
#   fb-test / fbgrab - quick "is the panel alive" checks
IMAGE_INSTALL:append = " fbset evtest libgpiod-tools fbgrab"
...
#
# STM32MP_ROOTFS_SIZE / STM32MP_USERFS_SIZE are set in conf/local.conf (they are plain
